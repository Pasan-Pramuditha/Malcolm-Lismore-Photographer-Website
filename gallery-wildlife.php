    ...
    <div class="container">
      <div class="row d-flex align-items-center justify-content-center">
        <div class="about-content col-lg-12" data-aos="fade-down">
          <h1 class="text-white">Wildlife Gallery</h1>
          <p class="text-white link-nav">
            <a href="index.php">Home </a>
            <span class="lnr lnr-arrow-right"></span>
            <a href="gallery-wildlife.php"> Wildlife Gallery </a>
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row mb-40 justify-content-center">
        <div class="col-lg-12 text-center" data-aos="fade-up">
          <div class="gallery-subnav">
            <a href="gallery-landscape.php">Landscape</a>
            <a href="gallery-wildlife.php" class="active">Wildlife</a>
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6 mb-30" data-aos="zoom-in">
          <img src="./assets/images/index/Wildlife-01.jpg" class="img-fluid gallery-img" alt="Wildlife 1" />
        </div>

        <div class="col-lg-4 col-md-6 mb-30" data-aos="zoom-in">
          <img src="./assets/images/index/Wildlife-02.jpg" class="img-fluid gallery-img" alt="Wildlife 2" />
        </div>
        <div class="col-lg-4 col-md-6 mb-30" data-aos="zoom-in">
          <img src="./assets/images/index/Wildlife-03.jpg" class="img-fluid gallery-img" alt="Wildlife 3" />
        </div>
        <div class="col-lg-4 col-md-6 mb-30" data-aos="zoom-in">
          <img src="./assets/images/index/Wildlife-04.jpg" class="img-fluid gallery-img" alt="Wildlife 4" />
        </div>
        <div class="col-lg-4 col-md-6 mb-30" data-aos="zoom-in">
          <img src="./assets/images/index/Wildlife-05.jpg" class="img-fluid gallery-img" alt="Wildlife 5" />
        </div>
        <div class="col-lg-4 col-md-6 mb-30" data-aos="zoom-in">
          <img src="./assets/images/index/Wildlife-06.jpg" class="img-fluid gallery-img" alt="Wildlife 6" />
        </div>
        <div class="col-lg-4 col-md-6 mb-30" data-aos="zoom-in">
          <img src="./assets/images/index/Wildlife-07.jpg" class="img-fluid gallery-img" alt="Wildlife 7" />
        </div>
        <div class="col-lg-4 col-md-6 mb-30" data-aos="zoom-in">
          <img src="./assets/images/index/Wildlife-08.jpg" class="img-fluid gallery-img" alt="Wildlife 8" />
        </div>
        <div class="col-lg-4 col-md-6 mb-30" data-aos="zoom-in">
          <img src="./assets/images/index/Wildlife-09.jpg" class="img-fluid gallery-img" alt="Wildlife 9" />
        </div>
  </section>
