    ...
    <div class="container">
      <div class="row d-flex align-items-center justify-content-center">
        <div class="about-content col-lg-12" data-aos="fade-down">
          <h1 class="text-white">Landscape Gallery</h1>
          <p class="text-white link-nav">
            <a href="index.php">Home </a>
            <span class="lnr lnr-arrow-right"></span>
            <a href="gallery-landscape.php"> Landscape Gallery </a>
          </p>
        </div>
      </div>
    </div>
  </section>
  <section class="section-gap mt-30">
    <div class="container">
      <div class="row mb-40 justify-content-center">
        <div class="col-lg-12 text-center" data-aos="fade-up">
          <div class="gallery-subnav">
            <a href="gallery-landscape.php" class="active">Landscape</a>
            <a href="gallery-wildlife.php">Wildlife</a>
            <a href="gallery-events.php">Weddings & Events</a>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6 mb-30" data-aos="zoom-in">
          <img src="./assets/images/index/Landscape-01.jpg" class="img-fluid gallery-img" alt="Landscape 1" />
        </div>
        <div class="col-lg-4 col-md-6 mb-30" data-aos="zoom-in">
          <img src="./assets/images/index/Landscape-02.jpg" class="img-fluid gallery-img" alt="Landscape 2" />
        </div>
        <div class="col-lg-4 col-md-6 mb-30" data-aos="zoom-in">
          <img src="./assets/images/index/Landscape-03.jpg" class="img-fluid gallery-img" alt="Landscape 3" />
        </div>
        <div class="col-lg-4 col-md-6 mb-30" data-aos="zoom-in">
          <img src="./assets/images/index/Landscape-04.jpg" class="img-fluid gallery-img" alt="Landscape 4" />
        </div>
        <div class="col-lg-4 col-md-6 mb-30" data-aos="zoom-in">
          <img src="./assets/images/index/Landscape-05.jpg" class="img-fluid gallery-img" alt="Landscape 5" />
        </div>
        <div class="col-lg-4 col-md-6 mb-30" data-aos="zoom-in">
          <img src="./assets/images/index/Landscape-06.jpg" class="img-fluid gallery-img" alt="Landscape 6" />
        </div>
        <div class="col-lg-4 col-md-6 mb-30" data-aos="zoom-in">
          <img src="./assets/images/index/Landscape-07.jpg" class="img-fluid gallery-img" alt="Landscape 7" />
        </div>
        <div class="col-lg-4 col-md-6 mb-30" data-aos="zoom-in">
          <img src="./assets/images/index/Landscape-08.jpg" class="img-fluid gallery-img" alt="Landscape 8" />
        </div>
        <div class="col-lg-4 col-md-6 mb-30" data-aos="zoom-in">
          <img src="./assets/images/index/Landscape-09.jpg" class="img-fluid gallery-img" alt="Landscape 9" />
        </div>
  </section>
